...
console.log(lista_impares);
    ...
    var lista_comida = ["tortilla","gambas","pan"]
    ...
    var lista_comida = ["tortilla","cangrejo","pan"]
    console.log(lista_comida);
...
while(i<20){
    if(i%2==0){
        listas_comida.push(i);
    }
    i = i + 1
}
console.log(listas_comida);
